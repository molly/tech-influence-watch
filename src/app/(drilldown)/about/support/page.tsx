      ...
      <div className={`${sharedStyles.main} ${styles.bodyText}`}>
        <div className="single-column-page">
          ...
          <div className={styles.aboutPage}>
            ...
            <p>
              The data here and the reporting in the newsletter are two parts of
              the same work: the newsletter&rsquo;s investigations into tech
              industry influence inform what gets tracked here, and{" "}
              <i>Tech Influence Watch</i> data powers and extends my reporting.
              If you&rsquo;ve found this data useful, there&rsquo;s a good
              chance the newsletter is worth your time too.
            </p>
            <p>
              This data is freely available and widely used by journalists,
              advocates, and policymakers working to hold the country&rsquo;s
              leaders and the tech industry accountable.
            </p>
            <p>
              Keeping it free, accurate, and independent costs time and money. I
              don&rsquo;t use paywalls, run ads, or accept industry funding. If
            ...
            <div className={styles.ctaBlock}>
              <div className={styles.ctaLabel}>
                Subscribe to Citation Needed
              </div>
              <p className={styles.ctaDescription}>
                An independent newsletter on cryptocurrency, technology, and
                tech policy by Molly White.
              </p>
              <a
