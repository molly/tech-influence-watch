...
import { getCompanyIdsForSector, humanizeSector } from "@/app/utils/sector";

import listStyles from "../listStyles.module.css";
import styles from "./page.module.css";

export function companiesMetadata(sector: Sector): Metadata {
...
export default async function CompaniesView({ sector }: { sector: Sector }) {
